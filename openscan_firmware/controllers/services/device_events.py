...
from openscan_firmware.routers.websocket import WebSocketHub, get_websocket_hub
...
class DeviceEventPublisher:
    ...
    def _resolve_status(self) -> dict[str, Any]:
        ...
        from openscan_firmware.controllers import device as device_controller  # Lazy import to avoid circular deps
